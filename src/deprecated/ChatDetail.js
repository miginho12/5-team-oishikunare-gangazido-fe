...
function ChatDetail() {
  ...
  const [messages, setMessages] = useState([
    ...
    {
      id: 2,
      text: "강아지 산책 시간 추천해주세요",
      isUser: true,
      time: "오전 10:31",
    },
    {
      id: 3,
      text: "현재 날씨가 맑고 온도가 적당하다면, 아침 8-10시 또는 저녁 4-6시가 좋습니다. 한낮에는 지면이 뜨거울 수 있어 강아지 발바닥에 화상을 입힐 수 있으니 피하는 것이 좋습니다.",
      isUser: false,
      time: "오전 10:32",
    },
  ]);
    ...
    <div className="flex flex-col h-full bg-gray-50">
      ...
      <div className="bg-white p-3 border-t border-gray-200">
        <form onSubmit={handleSendMessage} className="flex items-center">
          ...
          <button
            type="submit"
            className="p-2 rounded-full bg-amber-800 text-white"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="h-6 w-6"
      ...
      <nav className="bg-white border-t border-gray-200 shadow-lg">
        <div className="flex justify-around">
          ...
          <button
            onClick={goToChat}
            className="flex flex-col items-center py-3 px-4 text-amber-800"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="h-6 w-6"
